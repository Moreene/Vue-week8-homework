                        ...
                        <div class="col-10 mx-auto">
                            <div class="mb-16">
                                ...
                                <v-field id="title" name="餐點名稱" type="text" class="form-control" v-model="product.title"
                                    :class="{ 'is-invalid': errors['餐點名稱'] }" placeholder="請輸入餐點名稱"
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-16">
                                    ...
                                    <v-field id="origin_price" name="原價" type="number" min="0" class="form-control"
                                        v-model.number="product.origin_price" :class="{ 'is-invalid': errors['原價'] }"
                                        placeholder="請輸入原價" rules="required"></v-field>
                            ...
                            <div class="mb-16">
                                ...
                                <div class="tab-content" id="nav-tabContent">
                                    <div class="tab-pane show active pt-16 px-16" id="meat" role="tabpanel"
                                        ...
                                        <div class="form-check form-check-inline" v-for="item in ingredient.meat"
                                            ...
                                            <v-field name="ingredient" type="checkbox" class="form-check-input"
                                                :value="item" :id="item" v-model="product.ingredient"
                                    ...
                                    <div class="tab-pane pt-16 px-16" id="vegetable" role="tabpanel"
                                        ...
                                        <div class="form-check form-check-inline" v-for="item in ingredient.vegetable"
                                            :key="item">
                                            <v-field name="ingredient" type="checkbox" class="form-check-input"
                                                :value="item" :id="item" v-model="product.ingredient"
                                                :class="{ 'is-invalid': errors['ingredient'] }"
                                    ...
                                    <div class="tab-pane pt-16 px-16" id="seasoning" role="tabpanel"
                                        ...
                                        <div class="form-check form-check-inline" v-for="item in ingredient.seasoning"
                                            :key="item">
                                            <v-field name="ingredient" type="checkbox" class="form-check-input"
                                                :value="item" :id="item" v-model="product.ingredient"
                                                :class="{ 'is-invalid': errors['ingredient'] }"
                                    ...
                                    <div class="tab-pane pt-16 px-16" id="rice" role="tabpanel"
                                        aria-labelledby="rice-tab" tabindex="0">
