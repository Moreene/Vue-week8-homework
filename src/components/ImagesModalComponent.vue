      ...
      <div class="modal-content border-0">
        ...
        <v-form ref="form" v-slot="{ errors }" @submit="updateProduct">
              ...
              <div class="col-xl-5">
                <div class="bg-dark-blue p-32 rounded-1">
                  <div class="input-group mb-16">
                    <input type="file" class="form-control" aria-label="Upload" name="file-to-upload"
                      @change="uploadImg($event)" ref="fileInput">
                  </div>
              ...
              <div class="col-xl-5">
                <div class="mb-8">
                  <div class="mb-16">
                    ...
                    <v-field id="imageUrl" name="主圖連結" type="text" class="form-control" v-model="product.imageUrl"
                ...
                <div class="mb-8" v-if="product.imagesUrl">
                  <div class="mb-16" v-for="(item, idx) in product.imagesUrl" :key="'img' + idx">
                    ...
                    <v-field :id="'imageURL' + (idx + 1)" :name="'副圖' + (idx + 1)" type="text" class="form-control"
                      v-model="product.imagesUrl[idx]" :class="{ 'is-invalid': errors['副圖' + (idx + 1)] }"
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-outline-dark-blue w-25" data-bs-dismiss="modal" @click="clearInput">
              取消
            </button>
