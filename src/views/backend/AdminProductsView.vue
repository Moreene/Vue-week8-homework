<template>
    ...
    <div class="container py-144">
        ...
        <!-- 編輯圖片 -->
        <ImagesModalComponent ref="imageModal" :temp-product="tempProduct" @clear-input="clearImgInput" @update="getProduct"></ImagesModalComponent>
        <!-- 新增/編輯餐點 -->
    ...
    methods: {
        ...
        openModal(status, item) {
            if (status === 'new') {
                ...
                this.tempProduct = { ...item };
                this.isNew = false;
                this.$refs.imageModal.imageModal.show();
            } 
        ...
        clearImgInput(){
            ...
            this.$refs.modal.resetForm();
            this.$refs.imageModal.resetForm();
        },
    },
    mounted() {
