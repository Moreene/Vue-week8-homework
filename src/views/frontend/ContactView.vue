  ...
  <div class="container">
    <div class="py-72 py-lg-90">
      ...
      <div class="row justify-content-around gy-48 gy-md-0">
        <!-- 聯絡我們 -->
        <div class="col-md-6 col-lg-5" @mouseover="addTitleColor('contact')" @mouseout="removeTitleColor('contact')">
          ...
          <div class="h-100 d-flex flex-column">
            ...
            <v-form ref="form" v-slot="{ errors }" class="flex-grow-1 d-flex flex-column" @submit="submitForm">
              ...
              <div class="mb-16">
                ...
                <v-field id="email" name="email" type="email" class="form-control border-gray" v-model="email"
