              ...
              <div class="ps-12 py-16">
                <div class="row">
                  ...
                  <div class="col-9 col-lg-10">
                    <input type="text" class="form-control-plaintext" id="name" :value=order.user.name readonly>
                  </div>
                </div>
                <div class="row">
                  <label for="tel" class="col-3 col-lg-2 col-form-label">手機：</label>
                  <div class="col-9 col-lg-10">
                    <input type="tel" class="form-control-plaintext" id="tel" :value=order.user.tel readonly>
                  </div>
                </div>
                <div class="row">
                  <label for="email" class="col-3 col-lg-2 col-form-label">Email：</label>
                  <div class="col-9 col-lg-10">
                    <input type="email" class="form-control-plaintext" id="email" :value=order.user.email readonly>
                  </div>
                </div>
                <div class="row">
                  <label for="address" class="col-3 col-lg-2 col-form-label">地址：</label>
                  <div class="col-9 col-lg-10">
                    <input type="text" class="form-control-plaintext" id="address" :value=order.user.address readonly>
                  </div>
                </div>
                <div class="row">
              ...
              <div class="px-12 py-16">
                <div class="table-responsive">
                  <table class="table table-borderless mb-0">
                    <thead class="border-bottom border-dark border-top-0 border-start-0 border-end-0 text-nowrap">
                      <tr>
                ...
                <p class="ps-12 mt-24 fs-6 fw-bold mb-4">總金額：NT$ <span class="text-notoSans">{{ Math.round(order.total) }}</span><span class="text-danger fs-7"
            ...
            <div class="border border-dark bg-white">
              <v-form ref="form" class="px-12 py-16" v-slot="{ errors }" @submit="submitOrder">
                ...
                <div class="d-flex align-items-center mb-20">
                  ...
                  <v-field name="cardNum2" type="text" class="form-control border-gray w-20" @keyup="setBlur($event)"
                    :class="{ 'is-invalid': errors['cardNum2'] }" :rules="{ required: true, regex: /\d{4}/ }"
                    maxlength="4"></v-field>
                  <span class="px-6">-</span>
                  <v-field name="cardNum3" type="text" class="form-control border-gray w-20" @keyup="setBlur($event)"
                    :class="{ 'is-invalid': errors['cardNum3'] }" :rules="{ required: true, regex: /\d{4}/ }"
                    maxlength="4"></v-field>
                  <span class="px-6">-</span>
                  <v-field name="cardNum4" type="text" class="form-control border-gray w-20"
                    :class="{ 'is-invalid': errors['cardNum4'] }" :rules="{ required: true, regex: /\d/ }"
                    maxlength="4"></v-field>
                </div>
                ...
                <label for="securityNum" class="form-label mt-20">安全碼 <span class="text-danger">*</span></label>
                <v-field id="securityNum" name="securityNum" type="text" class="form-control border-gray"
                  :class="{ 'is-invalid': errors['securityNum'] }" placeholder="請輸入卡片背面末3碼" :rules="securityNum"
                  maxlength="3"></v-field>
